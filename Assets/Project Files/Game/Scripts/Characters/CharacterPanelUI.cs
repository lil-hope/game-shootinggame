...
namespace Watermelon.SquadShooter
{
    public class CharacterPanelUI : UIUpgradeAbstractPanel
    {
        ...
        public void Init(CharacterData character, UICharactersPanel charactersPanel)
        {
            ...
            {
                titleText.text = character.CharacterName.ToUpper();
        ...
        {
            bool firstSelect = selectedCharacterPanelUI == null;
            ...
            CharactersController.SelectCharacter(character);
        ...
        protected override void RedrawUpgradeButton()
        {
            if (!character.IsMaxUpgrade())
            {
                ...
                Currency currency = CurrencyController.GetCurrency(upgradeState.CurrencyType);
