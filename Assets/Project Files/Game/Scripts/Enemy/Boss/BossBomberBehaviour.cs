...
namespace Watermelon.SquadShooter
{
    public class BossBomberBehaviour : BaseEnemyBehavior
    {
        ...
        private VirtualCamera gameCameraCase;
        ...
        public override void Init()
        {
            ...
            gameCameraCase = CameraController.GetCamera(CameraType.Gameplay);
        ...
        public void OnBombExploded(BossBombBehaviour bossBombBehaviour, bool playerHitted)
        {
            ...
            if (distanceMultiplier != 0.0f)
                gameCameraCase.Shake(0.04f, 0.04f, Mathf.Lerp(bombShakeDurationMin, bombShakeDurationMax, distanceMultiplier), 1.4f);
        }
        ...
        private void OnBossHit()
        {
            ...
            bossBombBehaviour.Init(this, bombExplosionDuration, Random.Range(bombDamageMin, bombDamageMax), bombExplosionRadius);
