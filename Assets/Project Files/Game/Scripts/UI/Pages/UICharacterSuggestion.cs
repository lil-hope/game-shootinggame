...
namespace Watermelon.SquadShooter
{
    public class UICharacterSuggestion : UIPage
    {
        ...
        private static float lastProgression;
        ...
        {
            UICharacterSuggestion.lastProgression = lastProgression;
            UICharacterSuggestion.currentProgression = currentProgression;
            UICharacterSuggestion.characterData = characterData;
        }
