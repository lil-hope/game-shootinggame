    ...
    public class UniversalGUI : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (isLightColor == Switch.On)
            {
                ...
                _Shiness.floatValue = EditorGUILayout.Slider(_Shiness.floatValue, 0.01f, 1, GUILayout.Width(150));
                EditorGUILayout.EndHorizontal();
            ...
            if (isOutlineOn == Switch.On)
            {
                ...
                _OutlineDepthOffset.floatValue = EditorGUILayout.Slider(_OutlineDepthOffset.floatValue, 0.01f, 1, GUILayout.Width(150));
                EditorGUILayout.EndHorizontal();

                EditorGUILayout.BeginHorizontal();
                GUILayout.FlexibleSpace();
                GUILayout.Label("Distance Impact:", minStyle);
                _CameraDistanceImpact.floatValue = EditorGUILayout.Slider(_CameraDistanceImpact.floatValue, 0.01f, 1, GUILayout.Width(150));
                EditorGUILayout.EndHorizontal();
